...
class AllDoctors : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_all_doctors, container, false)
        initViews(view)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
               dialog.dismiss()
                ...
                for(d in snapshot.children ){
                    if(d.child("status").value.toString().equals("approved")){
    ...
    private fun initViews(view: View?) {
        recyclerView = view!!.findViewById(R.id.alldoc_recycler_view)
