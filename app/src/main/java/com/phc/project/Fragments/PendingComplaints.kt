...
class PendingComplaints : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_pending_complaints, container, false)
        initViews(view)
        Paper.init(activity)
        ...
        DBReferences.complaintRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for(d in snapshot.children ){
                    if(d.child("status").value.toString().equals("pending") && d.child("doc_email").value.toString().equals(email)){
    ...
    private fun initViews(view: View?) {
        recyclerView = view!!.findViewById(R.id.complants_recyclerview)
